            ...
            <div className="px-5 pb-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <div onClick={() => navigate(`/shop/${product.id}`)}
                 className="text-white bg-orange-500  hover:bg-orange-800 text-[12px] font-bold font-poppins rounded-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-pointer"
                >
                   View Details
                </div>
